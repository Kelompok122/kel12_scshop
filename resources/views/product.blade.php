...
<div class="container">
<center><h1 class="new_text"><strong>Produk Yang Tersedia Untuk Anda</strong></h1></center>
<br>
...
<br>
	<div class="container">
	<p><span class="font-weight-bold">{{ count($products) }}</span>Produk Yang Kami Sediakan</p>
	</div>
	<div id="product-list">
		<div class="container">
