...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span style="color:black">SC.Shop</span>
      </a>

      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="getstarted scrollto" href="/loginuser">Sign In</a></li>
          <li><a style="color:black" class="nav-link scrollto" href="/registration">Sign Up</a></li>
        </ul>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 style="color:black" data-aos="fade-up">Kami Menyediakan Berbagai Macam Mobil Sport </h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Dengan Desain Yang Elegan dan Nyaman dikemudikan.</h2>
