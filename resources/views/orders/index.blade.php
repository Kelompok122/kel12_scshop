					...
					<tbody>
						...
						<tr>
							...
							<td class="actions" data-th="">
                                <a href="/ordersadmin/edit/{{ $o->id }}"><button class="btn btn-success btn-sm update-cart">Edit</button></a>
                                <a href="/ordersadmin/{{ $o->id }}"><button class="btn btn-danger btn-sm mt-2 remove-from-cart">Hapus</button></a>
                            </td>
						</tr>
						@endforeach
					</tbody>
