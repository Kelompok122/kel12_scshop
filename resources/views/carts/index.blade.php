    ...
    <div class="container">
        <table id="id" class="table table-hover table-condensed">
                ...
                @if (session('cart'))
                    @foreach (session('cart') as $id => $product)
                        ...
                        <tr>
                            <td data-th="Product">
                                <div class="row">
                                    <div class="col-sm-3 hidden-xs">
                                        <img src="{{ route('storage.images', ['imageName' => $product['image_url']]) }}"
                            ...
                            <td data-th="Subtotal" class="text-center">Rp.{{ $product['price'] * $product['quantity'] }}
                            </td>
            ...
            <tfoot>
                ...
                <tr>
                    <td>
                        <a href="{{ url('/productcategory') }}" class="btn btn-primary"><i class="fa fa-angle-left"></i>Lanjutkan
                            Belanja</a>
                        <a href="{{ route('admin.orders.create') }}" class="btn btn-warning">Lanjut Ke Pembayaran</a>
                    </td>
