...
Route::post('product/{id}', [ProductReviewController::class, 'store'])->name('products.store');
...
Route::get('/mail', function () {
    \Mail::to('nnuurr030@gmail.com')
        ->send(new \App\Mail\PostMail('Mengirim Email Menggunakan SMTP Laravel 8', 'Chandrika'));
    return 'Terkirim';
});
